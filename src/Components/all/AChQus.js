          ...
          <Card className='cardContent' sx={{ width: 735 }}>
            ...
            <CardContent>
              ...
              <Typography variant='body2' color='text.secondary'>
                - 이메일 문의 : qqq11@naver.com<br></br>- 이메일 문의 :
                b2b2@google.com<br></br>- 전화 문의 : 02-1111-1111<br></br>-
                서울특별시 노원구 OO동 A학원
              </Typography>
            </CardContent>
            <CardActions>
              <Button href='http://localhost:3000/A_ch_intro' size='small'>
                소개
              </Button>
