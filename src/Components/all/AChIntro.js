          ...
          <Card className='cardContent' sx={{ width: 735 }}>
            ...
            <CardContent>
              ...
              <Typography variant='body2' color='text.secondary'>
                - 수학, 영어 전문 학원!<br></br>- 각 분야의 최고 선생님들이
                가르치는 수업<br></br>- 상담선생님도 따로 계시니까 저희 학원으로
                전화주세요 ^^<br></br>- 서울특별시 노원구 OO동 A학원
              </Typography>
            </CardContent>
            <CardActions>
              <Button href='http://localhost:3000/A_ch_qus' size='small'>
                문의
              </Button>
              <Button href='http://localhost:3000/A_ch' size='small'>
                채널 바로가기
              </Button>
            </CardActions>
          </Card>
